...
public class TitanicExperienceBottleItem extends Item implements ProjectileItem {
    public TitanicExperienceBottleItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(ThrownTitanicExperienceBottle::new, serverLevel, itemStack, player, -20.0F, 0.7F, 1.0F);
        }
