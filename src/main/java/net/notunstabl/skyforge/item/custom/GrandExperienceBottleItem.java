...
import net.notunstabl.skyforge.entity.projectile.throwableitemprojectile.ThrownGrandExperienceBottle;

public class GrandExperienceBottleItem extends Item implements ProjectileItem {
    public GrandExperienceBottleItem (Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(ThrownGrandExperienceBottle::new, serverLevel, itemStack, player, -20.0F, 0.7F, 1.0F);
        }
