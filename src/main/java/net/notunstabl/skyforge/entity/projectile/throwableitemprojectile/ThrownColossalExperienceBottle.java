...
public class ThrownColossalExperienceBottle extends ThrowableItemProjectile {
    public ThrownColossalExperienceBottle(EntityType<? extends ThrownExperienceBottle> type, Level level) {
        super(type, level);
    }

    public ThrownColossalExperienceBottle(Level level, LivingEntity mob, ItemStack itemStack) {
