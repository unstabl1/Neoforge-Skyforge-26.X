...
public class ThrownTitanicExperienceBottle extends ThrowableItemProjectile {
    public ThrownTitanicExperienceBottle(EntityType<? extends ThrownExperienceBottle> type, Level level) {
        super(type, level);
    }

    public ThrownTitanicExperienceBottle(Level level, LivingEntity mob, ItemStack itemStack) {
